    ...
    <>
      <PageSection>
        ...
        <Typography>
          ...
          to provide an interface for exploring Deep Zoom Images.
          <br /> Deep Zoom Images are a way to view massive images such as map
          data, and it works by creating tiles of the full resolution image at
          several zoom levels, which are then fetched when they're visible on
          the screen. Specifically, this app uses a library called{" "}
          <a
